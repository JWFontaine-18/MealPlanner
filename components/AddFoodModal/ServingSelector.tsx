...
import { servingSelectorStyles as styles } from '@/styles/components/ServingSelector';
...
function getContextualServingUnits(
  foodName: string,
  householdServing?: string,
  servingSize?: number,
  servingSizeUnit?: string
...
export function ServingSelector({
  ...
  const servingUnits = getContextualServingUnits(
    foodName,
    householdServing,
    servingSize,
    servingSizeUnit
      ...
      <View style={styles.servingContainer}>
        ...
        <View style={styles.amountContainer}>
          <TouchableOpacity
            ...
            onPress={() => adjustAmount(-selectedUnit.step)}
          >
